...
trait PlatformComponent {
  case class Platform(id: Option[Long], name: String, updatedAt: String, createdAt: String)
...
trait ProductComponent {
  self: PlatformComponent =>
    ...
    case class Product(id: Option[Long], name: String, platform: Long, version: String, description: Option[String], updatedAt: String, createdAt: String) 
  /**
  ...
  // class Products(tag: Tag) extends Table[Long, String, String, String, Option[String], String, String](tag, "PRODUCTS") {
    ...
    def platform = foreignKey("PLATFORM_FK", platformId, platforms)
  }
